...
const Comment = (props: ICommentProps) => {
    return (
        <div className="flex flex-col bg-[#494949] h-[8.5rem] w-[95%] mt-[1rem] self-center flex-shrink-0">
            ...
            <hr className="mt-2" />
            <textarea className="text-white mt-2 text-sm bg-[#494949] h-16 w-full resize-none indent-2" readOnly>
                {props.comment}
            </textarea>
        </div>
    )
